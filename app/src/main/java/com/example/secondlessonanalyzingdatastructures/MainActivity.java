package com.example.secondlessonanalyzingdatastructures;
...
//        button.setOnClickListener(listener);
    ...
    private List<Integer> addList(List<Integer> list) {
        int integerBefore = 0; // определение первого элемента ряда Фибоначчи
        int integerAfter = 1; // определение второго элемента ряда Фибоначчи
        int integer; // определение последующих элементов ряда Фибоначчи
        list.add(integerBefore); // добавление в список первого элемента ряда Фибоначчи
        list.add(integerAfter); // добавление в список второго элемента ряда Фибоначчи
        // заполнение списка остальными элементами ряда Фибоначчи
    ...
    // метод заполнения списка рядом арифметической прогрессии на 10 (0, 10, 20, 30, 40, 50, …)
